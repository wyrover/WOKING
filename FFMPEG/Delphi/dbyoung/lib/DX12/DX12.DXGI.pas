...
type
  ...
  IDXGIOutput = interface(IDXGIObject)
    ...
    function FindClosestMatchingMode(const pModeToMatch: PDXGI_MODE_DESC; out pClosestMatch: TDXGI_MODE_DESC; pConcernedDevice: IUnknown): HResult; stdcall;
  ...
  IDXGIDevice = interface(IDXGIObject)
    ...
    function CreateSurface(const pDesc: PDXGI_SURFACE_DESC; NumSurfaces: UINT; Usage: TDXGI_USAGE; const pSharedResource: PDXGI_SHARED_RESOURCE; out ppSurface: IDXGISurface): HResult; stdcall;
    function QueryResourceResidency(const ppResources: PIUnknown; out pResidencyStatus: PDXGI_RESIDENCY; NumResources: UINT): HResult; stdcall;
